...
import gbrAkun6 from "/assets/akun6.jpg.jpeg";
import gbrAkun7 from "/assets/akun7.jpg.jpeg";
import gbrAkun8 from "/assets/akun8.jpg.jpeg";
  ...
  const listAkun = [
    {
      ...
      deskripsi:
        "Akun pribadi aman 100%. Login Moonton (sepaket email). Skin Collector melimpah, Emblem Max, Winrate mantap.",
      fotoProfil: gbrAkun1,
      gambar: gbrAkun1,
      isReady: true,
    ...
    },
    {
      ...
      deskripsi:
        "Akun spek standar cocok buat push rank. Skin Epic banyak. Akun aman anti hackback.",
      fotoProfil: gbrAkun2,
      gambar: gbrAkun2,
      isReady: false,
    ...
    },
    {
      ...
      deskripsi:
        "Akun Rank Tinggi (Immortal). Skin KOF & Limited. Cocok untuk pamer di lobby!",
      fotoProfil: gbrAkun3,
      gambar: gbrAkun3,
      isReady: true,
    ...
    },
    {
      ...
      harga: "Rp 500.000",
      fitur: "monsep",
      deskripsi: "Akun bekas rrq",
      fotoProfil: gbrAkun6,
      gambar: gbrAkun6,
      isReady: true,
      pesan: "Halo mau beli akun ml no 6",
    },
    {
      id: 8,
      nama: "Akun ML 8",
      harga: "Rp 500.000",
      fitur: "Monsep",
      deskripsi: "akun murah",
      fotoProfil: gbrAkun7,
      gambar: gbrAkun7,
      isReady: true,
      pesan: " Mau beli akun ml no 8",
    },
    {
      id: 9,
      nama: "Akun Ml9",
  ...
  const testimoni = [
    {
      ...
      nama: "Andi Pratama",
      ulasan:
        "Awalnya ragu, pas beli ternyata prosesnya cepet banget. Akun aman 100%!",
      bintang: "⭐⭐⭐⭐⭐",
    },
    {
      id: 2,
      nama: "Budi Jagoan",
      ulasan:
        "Adminnya ramah, nanya-nanya spek dijawab detail. Recommended seller!",
      bintang: "⭐⭐⭐⭐⭐",
    },
    {
      id: 3,
      nama: "Siska Amelia",
      ulasan:
        "Akun sultan beneran, sesuai gambar. Gak nyesel beli di Rizall Storeee.",
      bintang: "⭐⭐⭐⭐⭐",
    },
    {
      id: 4,
      nama: "Rizky Ramadhan",
      ulasan: "Proses ganti data dibantu sampai selesai. Mantap bang Rizal!",
      bintang: "⭐⭐⭐⭐⭐",
    },
    {
      id: 5,
      nama: "Uknow",
      ulasan: "kak rizal ganteng. Mantap kak Rizal!",
      bintang: "⭐⭐⭐⭐⭐",
    },
  ];
          ...
          <div className="grid-akun">
            {filteredAkun.length > 0 ? (
              filteredAkun.map((akun) => (
                ...
                >
                  <div
                    className={`badge-status ${akun.isReady ? "ready" : "sold"}`}
                  >
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-galeri">
                <img
                  src={
                    Array.isArray(selectedAkun.gambar)
                      ? selectedAkun.gambar[activeImageIndex]
                      : selectedAkun.gambar
                  }
      ...
      <footer className="footer">
        <div className="container footer-content">
          <div className="footer-info">
            ...
            <p>
              Jasa jual beli akun game terpercaya, aman, dan anti hackback.
              Transaksi kilat admin ramah.
            </p>
          </div>
